...
// Source: github.com/mitrich772/go-order-service/internal/cache (interfaces: Cache)
...
func (m *MockCache) Get(arg0 string) (*database.Order, bool) {
	m.ctrl.T.Helper()
...
func (m *MockCache) Set(arg0 *database.Order) bool {
	m.ctrl.T.Helper()
